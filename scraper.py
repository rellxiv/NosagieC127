...
def scrape():
    ...
    for i in range(0,10):
        ...
        # Current Page Number
        cpn = int(soup.find_all("input", attrs={"class", "page_num"})[0].get("value"))

        # XPATH
        if(cpn < i):
            browser.find_element(by=By.XPATH, value='//*[@id="primary_column"]/footer/div/div/div/nav/span[2]/a').click()
            # //*[@id="results"]/ul[2]/li[1]/a
        elif(cpn > i):
        ...
        for ul_tag in soup.find_all("ul", attrs={"class", "exoplanet"}):
            ...
            hyperlinkLItag = li_tags[0]
            temp_list.append("https://exoplanets.nasa.gov" + hyperlinkLItag.find_all("a", href = True)[0]["href"])
...
# Convert to CSV
planet_df_1.to_csv('upd_scraped_data.csv',index=True, index_label="id")
